...
/**
 * Correios_Offline_Package class.
 */
class Correios_Offline_Package {
	...
	public function get_data() {
		// Get the package data.
		$data = apply_filters( 'correios_offline_default_package', $this->get_package_data() );
		...
		return array(
			'height' => apply_filters( 'correios_offline_package_height', $cubage['height'] ),
			'width'  => apply_filters( 'correios_offline_package_width', $cubage['width'] ),
			'length' => apply_filters( 'correios_offline_package_length', $cubage['length'] ),
			'weight' => apply_filters( 'correios_offline_package_weight', $data['weight'] ),
		);
	}
}
