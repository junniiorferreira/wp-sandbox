 ...
 *
 * @package correios_offline/Classes/Cart
 * @since   3.7.0
 * @version 3.7.0
 */
...
class Correios_Offline_Cart {
	...
	public function shipping_delivery_forecast( $shipping_method ) {
		...
		if ( $total ) {
			...
			echo '<p><small>' . esc_html( sprintf( _n( 'Delivery within %d working day', 'Delivery within %d working days', $total, 'correios-offline' ), $total ) ) . '</small></p>';
		}
	}
}

new Correios_Offline_Cart();
