 ...
 */
class Correios_Offline_Shipping_Carta_Registrada extends Correios_Offline_Shipping_Carta {
	...
	public function __construct( $instance_id = 0 ) {
		$this->id                 = 'correios-offline-carta-registrada';
		$this->method_title       = __( 'Carta Registrada Offline', 'correios-offline' );
	...
	protected function get_costs() {
		return apply_filters( 'correios_offline_carta_registrada_costs', array(
			'20'  => array(
				'R'     => 6.85,
				'AR'    => 11.85,
				'MP'    => 12.75,
