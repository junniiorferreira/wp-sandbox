 ...
 */
class Correios_Offline_Shipping_Impresso_Normal extends Correios_Offline_Shipping_Impresso {
	...
	public function __construct( $instance_id = 0 ) {
		$this->id           = 'correios-offline-impresso-normal';
		$this->method_title = __( 'Impresso Normal Offline', 'correios-offline' );
	...
	protected function get_additional_costs_per_kg() {
		return apply_filters( 'correios_offline_impresso_additional_cost_per_kg',
	...
	protected function get_costs() {
		return apply_filters( 'correios_offline_impresso_normal_costs', array(
			'20'  => 1.10,
			'50'  => 1.65,
			'100' => 2.15,
			'150' => 2.60,
