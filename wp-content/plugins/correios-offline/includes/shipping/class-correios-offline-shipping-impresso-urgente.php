 ...
 */
class Correios_Offline_Shipping_Impresso_Urgente extends Correios_Offline_Shipping_Impresso {
	...
	public function __construct( $instance_id = 0 ) {
		$this->id           = 'correios-offline-impresso-urgente';
		$this->method_title = __( 'Impresso Urgente Offline', 'correios-offline' );
	...
	protected function get_costs() {
		return apply_filters( 'correios_offline_impresso_urgente_costs', array(
			'20'  => 1.55,
			'50'  => 2.15,
			'100' => 2.95,
			'150' => 3.60,
