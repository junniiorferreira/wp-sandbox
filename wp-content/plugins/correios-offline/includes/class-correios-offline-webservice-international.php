 ...
 */
class Correios_Offline_Webservice_International {
	...
	public function get_webservice_url() {
		return apply_filters( 'correios_offline_webservice_international_url', $this->_webservice, $this->id, $this->instance_id, $this->package );
	}
	...
	public function get_allowed_countries() {
		return apply_filters( 'correios_offline_international_allowed_countries', array(
			'AD',
			'AE',
			'AF',
			'AG',
	...
	public function get_origin_location() {
		...
		return apply_filters( 'correios_offline_international_origin_location', $this->origin_location, $this->id, $this->instance_id, $this->package );
	}
	...
	public function get_origin_state() {
		return apply_filters( 'correios_offline_international_origin_state', $this->origin_state, $this->id, $this->instance_id, $this->package );
	}
	...
	public function get_shipping() {
		...
		$args = apply_filters( 'correios_offline_international_shipping_args', array(
			'tipoConsulta' => 'Geral',
