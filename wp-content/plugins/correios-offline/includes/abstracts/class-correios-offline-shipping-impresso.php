 ...
 */
abstract class Correios_Offline_Shipping_Impresso extends Correios_Offline_Shipping_Carta {
	...
	public function init_form_fields() {
		$this->instance_form_fields = array(
			...
			'shipping_class' => array(
				...
				'type'        => 'select',
				'description' => __( 'Select for which shipping class this method will be applied.', 'correios-offline' ),
				'desc_tip'    => true,
				'default'     => '',
			...
			'registry_type' => array(
				'title'       => __( 'Registry Type', 'correios-offline' ),
				'type'        => 'select',
				'description' => __( 'Select for which registry type this method will be applied.', 'correios-offline' ),
				'desc_tip'    => true,
				'default'     => '',
				'class'       => 'wc-enhanced-select',
				'options'     => array(
					''   => __( '-- Select a registry type --', 'correios-offline' ),
					'RN' => __( 'Registro Nacional', 'correios-offline' ),
					'RM' => __( 'Registro Módico', 'correios-offline' ),
				),
				'default'     => 'RM',
			),
			...
			'additional_time' => array(
				'title'       => __( 'Delivery Days', 'correios-offline' ),
				'type'        => 'text',
				'description' => __( 'Working days to the estimated delivery.', 'correios-offline' ),
				'desc_tip'    => true,
				'default'     => '0',
				'placeholder' => '0',
			),
			'extra_weight' => array(
				'title'       => __( 'Extra Weight (g)', 'correios-offline' ),
				'type'        => 'text',
				'description' => __( 'Extra weight in grams to add to the package total when quoting shipping costs.', 'correios-offline' ),
				'desc_tip'    => true,
				'default'     => '0',
			),
			'fee' => array(
