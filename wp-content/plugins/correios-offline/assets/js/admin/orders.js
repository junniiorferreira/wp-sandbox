...
jQuery( function( $ ) {
	...
	var WCCorreiosAdminOrders = {
		...
		addTrackingFields: function( trackingCodes ) {
			var $wrap = $( 'body #Correios_Offline .correios-tracking-code' );
		...
		addTrackingCode: function( evt ) {
			...
			var data = {
				action: 'correios_offline_add_tracking_code',
		...
		removeTrackingFields: function( $el ) {
			var $wrap = $( 'body #Correios_Offline .correios-tracking-code__list' );
		...
		removeTrackingCode: function( evt ) {
			...
			var $el  = $( this );
			var data = {
				action: 'correios_offline_remove_tracking_code',
