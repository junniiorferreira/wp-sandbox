...
Confira o nosso guia de instalação e configuração do Correios na aba [Installation](http://wordpress.org/extend/plugins/correios-offline/installation/).
...
- A nossa sessão de [FAQ](http://wordpress.org/extend/plugins/correios-offline/faq/).
- Utilizando o nosso [fórum no Github](https://github.com/claudiosanches/correios-offline).
- Criando um tópico no [fórum de ajuda do WordPress](http://wordpress.org/support/plugin/correios-offline).
...
Se ainda não foi capaz de solucionar o problema, copie o conteúdo do arquivo de log, cole no [pastebin.com](http://pastebin.com), salve e pegue o link gerado, depois disso abra um tópico informando o seu problema no [fórum de suporte do plugin](https://wordpress.org/support/plugin/correios-offline/#new-post).

= Dúvidas sobre o funcionamento do plugin? =

Em caso de dúvidas, basta abrir um tópico no [fórum de suporte do plugin](https://wordpress.org/support/plugin/correios-offline/#new-post), vou responder conforme eu tenho tempo livre e caso sua dúvida for relacionada com o funcionamento deste plguin.
...
- Atualizados os valores do Impresso e Carta, mais detalhes em [#97](https://github.com/claudiosanches/correios-offline/pull/97) e [#100](https://github.com/claudiosanches/correios-offline/pull/100).
- Adicionada opção para peso extra nos métodos de Impresso e Carta, mais detalhes em [#95](https://github.com/claudiosanches/correios-offline/pull/95).
- Adicionada opções para usar rastreamento com dados administrativos.
- Melhorado a exibição e salvamento da estimativa de entrega, mais detalhes em [#98](https://github.com/claudiosanches/correios-offline/pull/98)

[See changelog for all versions](https://raw.githubusercontent.com/claudiosanches/correios-offline/master/CHANGELOG.txt).
